...
export const metadata: Metadata = {
    title: 'Portfolio - Talha Javaid Mughal',
    description: 'Full Stack Engineer with 6+ years of experience in microservices architecture, RESTful APIs, and distributed systems',
};
